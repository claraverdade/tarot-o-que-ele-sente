...
const TestimonialsSection = () => {
  ...
  return <section className="py-20 bg-mystical-beige">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="mystical-card p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <div className="flex items-center gap-1 mb-4">
                  {[...Array(5)].map((_, starIndex) => <Star key={starIndex} className="w-4 h-4 fill-mystical-purple text-mystical-purple" />)}
                </div>
